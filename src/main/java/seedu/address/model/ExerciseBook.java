...
import seedu.address.model.exercise.ExerciseList;
...
public class ExerciseBook implements ReadOnlyExerciseBook {
    ...
    public String toString() {
        exercises.asUnmodifiableObservableList().stream().forEach(x -> {
            System.out.println("Name: " + x.getName().exerciseName);
            System.out.println("Description: " + x.getDescription().description);
